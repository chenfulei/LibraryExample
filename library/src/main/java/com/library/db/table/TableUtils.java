...
import com.library.db.annotation.FLTable;
...
public class TableUtils {
    ...
    public static String getTableName(Class<?> entityType) {
        FLTable table = entityType.getAnnotation(FLTable.class);
    ...
    private static void addColumns2Map(Class<?> entityType, String primaryKeyFieldName, HashMap<String, Column> columnMap) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (FLColumnConverterFactory.isSupportColumnConverter(field.getType())) {
    ...
    static synchronized Id getId(Class<?> entityType) {
        ...
        if (fields != null) {
            ...
            for (Field field : fields) {
                if (field.getAnnotation(FLId.class) != null) {
