...
/**
 * 图片缩放控件（支持缩放、拖动、双击、旋转）<br>
 * @author chen_fulei
 *
 */
public class FLScaleImageView extends ImageView{
	 public enum ImageState {
	    ...
	    public FLScaleImageView(Context context) {
	        super(context);
	        initView();
	    }

	    public FLScaleImageView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        initView();
	    }

	    public FLScaleImageView(Context context, AttributeSet attrs, int defStyle) {
